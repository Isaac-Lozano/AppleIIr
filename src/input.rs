...
impl Input {
    ...
    fn map_keycode(opt_code: Option<Keycode>, keyboard: &KeyboardUtil) -> Option<u8> {
        ...
        let mut ch = match code {
            ...
            Keycode::Y => 'Y' as u8,
            Keycode::Z => 'Z' as u8,
            Keycode::RightBracket => ']' as u8,
            Keycode::Space => ' ' as u8,
            Keycode::Quote => '\'' as u8,
            Keycode::Comma => ',' as u8,
            Keycode::Minus => '-' as u8,
            Keycode::Period => '.' as u8,
            Keycode::Slash => '/' as u8,
            Keycode::Num0 => '0' as u8,
            Keycode::Num1 => '1' as u8,
            Keycode::Num2 => '2' as u8,
            Keycode::Num3 => '3' as u8,
            Keycode::Num4 => '4' as u8,
            Keycode::Num5 => '5' as u8,
            Keycode::Num6 => '6' as u8,
            Keycode::Num7 => '7' as u8,
            Keycode::Num8 => '8' as u8,
            Keycode::Num9 => '9' as u8,
            Keycode::Semicolon => ';' as u8,
            Keycode::Equals => '=' as u8,
            Keycode::Return => 0x0D,
